...
import com.tareas2p.appfirma.R;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(Signatures signatures);
    }

    public interface OnItemDoubleClickListener {
        void onItemDoubleClick(Signatures photos);
    }

    public ListAdapter(List<Signatures> itemList, Context context, ListAdapter.OnItemClickListener listener,OnItemDoubleClickListener doubleClickListener) {
...
//        holder.imageView.setImageBitmap(bitmap);
    ...
    public void setItems(List<Signatures> items) {
        datos = items;
    }

    public void setFilteredList(List<Signatures> filteredList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(final Signatures signatures) {
            //id.setText(signatures.getId());
            //descripcion.setText(signatures.getDescripcion());
            //limpiarSeleccion();
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClick(signatures);
                }
            });
        }
